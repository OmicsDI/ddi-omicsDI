...
@ContextConfiguration(locations = {"classpath:jobs/cellcollective/ddi-indexer-test-cellcollective-import.xml"})
public class ImportCellCollectiveXMLTaskletTest {

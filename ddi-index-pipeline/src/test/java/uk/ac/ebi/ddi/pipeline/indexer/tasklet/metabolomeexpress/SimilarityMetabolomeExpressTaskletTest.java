package uk.ac.ebi.ddi.pipeline.indexer.tasklet.metabolomeexpress;
...
@ContextConfiguration(locations = {"classpath:jobs/metabolomeexpress/ddi-indexer-test-metabolomeexpress-similarity.xml"})
public class SimilarityMetabolomeExpressTaskletTest {

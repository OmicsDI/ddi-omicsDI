package uk.ac.ebi.ddi.pipeline.indexer.tasklet.cellcollective;
...
@ContextConfiguration(locations = {"classpath:jobs/cellcollective/ddi-indexer-test-cellcollective-generate.xml"})
public class GenerateCellCollectiveXMLTaskletTest {

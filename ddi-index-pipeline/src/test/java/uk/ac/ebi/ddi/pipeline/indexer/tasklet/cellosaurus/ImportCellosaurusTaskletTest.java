package uk.ac.ebi.ddi.pipeline.indexer.tasklet.cellosaurus;
...
@ContextConfiguration(locations = {"classpath:jobs/cellosaurus/ddi-indexer-test-cellosaurus-import.xml"})
public class ImportCellosaurusTaskletTest {

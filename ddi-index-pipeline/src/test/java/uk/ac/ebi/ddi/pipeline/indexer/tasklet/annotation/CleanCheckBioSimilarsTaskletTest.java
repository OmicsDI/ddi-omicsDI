...
/**
 * Created by yperez on 26/07/2016.
 */

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {"classpath:jobs/similars/ddi-index-test-check-clean-biological-similarity.xml"})
public class CleanCheckBioSimilarsTaskletTest {
    ...
    @Autowired
    @Qualifier("ddiCleanBiologicalSimilarsJob")
    private Job job;

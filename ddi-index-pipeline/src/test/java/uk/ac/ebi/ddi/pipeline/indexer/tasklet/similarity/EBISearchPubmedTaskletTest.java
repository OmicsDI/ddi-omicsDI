...
@ContextConfiguration(locations = {"classpath:jobs/similars/ddi-indexer-test-ebisearch.xml"})
public class EBISearchPubmedTaskletTest {
    ...
    @Autowired
    @Qualifier("ddiEBISearchPubmedJob")
    private Job job;

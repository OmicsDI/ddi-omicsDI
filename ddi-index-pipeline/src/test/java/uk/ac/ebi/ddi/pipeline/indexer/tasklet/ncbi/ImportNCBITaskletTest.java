package uk.ac.ebi.ddi.pipeline.indexer.tasklet.ncbi;
...
@ContextConfiguration(locations = {"classpath:jobs/ncbi/ddi-indexer-test-ncbi-import.xml"})
public class ImportNCBITaskletTest {

...
@ContextConfiguration(locations = {"classpath:jobs/metabolomeexpress/ddi-indexer-test-metabolomeexpress-import.xml"})
public class ImportEBeyeMetabolomeExpressXMLTaskletTest {

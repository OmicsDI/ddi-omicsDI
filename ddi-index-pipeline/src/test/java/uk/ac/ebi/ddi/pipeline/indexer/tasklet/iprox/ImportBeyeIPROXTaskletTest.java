package uk.ac.ebi.ddi.pipeline.indexer.tasklet.iprox;
...
@ContextConfiguration(locations = {"classpath:jobs/iprox/ddi-indexer-test-iprox-import.xml"})
public class ImportBeyeIPROXTaskletTest {

...
@ContextConfiguration(locations = {"classpath:jobs/expressionatlas/ddi-indexer-test-expressionatlas-import.xml"})
public class ImportEBeyeExpressionAtlasTaskletTest {

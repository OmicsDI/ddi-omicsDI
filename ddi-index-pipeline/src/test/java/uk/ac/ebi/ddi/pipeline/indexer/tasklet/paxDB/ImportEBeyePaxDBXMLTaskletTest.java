package uk.ac.ebi.ddi.pipeline.indexer.tasklet.paxDB;
...
@ContextConfiguration(locations = {"classpath:jobs/paxdb/ddi-indexer-test-paxdb-import.xml"})
public class ImportEBeyePaxDBXMLTaskletTest {

...
@ContextConfiguration(locations = {"classpath:jobs/expressionatlas/ddi-indexer-test-expressionatlas-similarity.xml"})
public class SimilarityExpressionAtlasTaskletTest {

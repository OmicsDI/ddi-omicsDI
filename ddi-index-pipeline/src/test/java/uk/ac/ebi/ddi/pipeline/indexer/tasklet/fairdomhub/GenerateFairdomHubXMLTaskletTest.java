package uk.ac.ebi.ddi.pipeline.indexer.tasklet.fairdomhub;
...
@ContextConfiguration(locations = {"classpath:jobs/fairdomhub/ddi-indexer-test-fairdomhub-generate.xml"})
public class GenerateFairdomHubXMLTaskletTest {

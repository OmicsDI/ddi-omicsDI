...
@ContextConfiguration(locations = {"classpath:jobs/biomodels/ddi-indexer-test-biomodels-annotation-files-step.xml"})
public class AnnotationFilesBioModelsXMLTaskletTest {

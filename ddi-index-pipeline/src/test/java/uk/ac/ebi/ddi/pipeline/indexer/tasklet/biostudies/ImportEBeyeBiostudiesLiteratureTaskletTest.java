...
@ContextConfiguration(locations = {"classpath:jobs/biostudies/ddi-indexer-test-biostudies-literature-import.xml"})
public class ImportEBeyeBiostudiesLiteratureTaskletTest {

package uk.ac.ebi.ddi.pipeline.indexer.tasklet.node;
...
@ContextConfiguration(locations = {"classpath:jobs/node/ddi-indexer-test-node-import.xml"})
public class ImportEBeyeNODEXMLTaskletTest {

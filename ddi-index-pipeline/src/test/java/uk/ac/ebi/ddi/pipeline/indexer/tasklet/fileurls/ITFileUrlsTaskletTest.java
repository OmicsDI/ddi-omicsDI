package uk.ac.ebi.ddi.pipeline.indexer.tasklet.fileurls;
...
@ContextConfiguration(locations = {"classpath:jobs/fileurls/ddi-indexer-test-fileurls.xml"})
public class ITFileUrlsTaskletTest {
    ...
    @Autowired
    @Qualifier("ddiDatasetFileUrlRetrieveJob")
    private Job job;

package uk.ac.ebi.ddi.pipeline.indexer.tasklet.downloadcount;
...
@ContextConfiguration(locations = {"classpath:jobs/downloadcount/ddi-indexer-test-download-count.xml"})
public class DownloadCountTaskletTest {

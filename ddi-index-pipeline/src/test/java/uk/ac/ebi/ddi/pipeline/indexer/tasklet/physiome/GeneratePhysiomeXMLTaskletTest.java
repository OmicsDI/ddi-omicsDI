package uk.ac.ebi.ddi.pipeline.indexer.tasklet.physiome;
...
@ContextConfiguration(locations = {"classpath:jobs/physiome/ddi-indexer-test-physiome-generate.xml"})
public class GeneratePhysiomeXMLTaskletTest {

package uk.ac.ebi.ddi.pipeline.indexer.tasklet.panorama;
...
@ContextConfiguration(locations = {"classpath:jobs/panorama/ddi-indexer-test-panorama-import.xml"})
public class ImportEBeyePanoramaPublicTaskletTest {

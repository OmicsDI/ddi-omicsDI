...
@ContextConfiguration(locations = {"classpath:jobs/biostudies/ddi-indexer-test-biostudies-arrayexpress-import.xml"})
public class ImportEBeyeBiostudiesArrayExpressTaskletTest {

...
public class RepositoryRecordType
    ...
    protected List<RefType> sourceFileRef;
    @XmlElement(name = "PublicationRef")
    protected List<RefType> publicationRef;
    @XmlElement(name = "InstrumentRef")
    protected List<RefType> instrumentRef;
    ...
    protected AdditionalInformationType annotationList;

...
import uk.ac.ebi.ddi.ws.modules.model.SynonymsForDataset;
import uk.ac.ebi.ddi.ws.modules.model.SynonymsForWord;
import uk.ac.ebi.ddi.ws.modules.model.DataSetResult;
import uk.ac.ebi.ddi.ws.modules.model.DatasetSummary;
import uk.ac.ebi.ddi.ws.modules.model.SimilarInfoResult;

import uk.ac.ebi.ddi.ws.modules.util.Constants;
import uk.ac.ebi.ddi.ws.modules.util.Triplet;
...
@Tag(name = "enrichment", description = "Retrieve the information about the enrichment and synonyms ")
@Controller
...
public class EnrichmentController {
    ...
    DatabaseDetailService databaseDetailService;
     ...
     @Operation(summary = "Get enrichment Info", description = "Retrieve the enrichment data for a dataset")
    ...
    public DatasetEnrichmentInfo getEnrichmentInfo(
             @Parameter(description = "Dataset accession")
            @RequestParam(value = "accession", required = true, defaultValue = "PXD002287") String accession,
             @Parameter(description = "Database name, e.g: PRIDE")
     ...
     @Operation(summary = "Get synonyms for a dataset", description = "Retrieve all synonyms for the words in a dataset")
    ...
    private List<String> getEnrichedWordsInDataset(DatasetEnrichmentInfo enrichmentInfo) {
     ...
     @Operation(summary = "Get similar datasets for a dataset", description = "Retrieve all similar datasets for the dataset")
    ...
    private List<DatasetSummary> addScores(List<DatasetSummary> dsSummaries, List<IntersectionInfo> intersecInfos) {
     ...
     @Operation(summary = "Get similarity information for a dataset", description = "Retrieve similarity info between the datasets that is similar to the given dataset, "
    ...
    public SimilarInfoResult getSimilarityInfo(
            ...
            @RequestParam(value = "accession", required = true, defaultValue = "PXD000002") String accession,
             @Parameter(description = "Database name, e.g: PRIDE")
            @RequestParam(value = "database", required = true, defaultValue = "PRIDE") String database,
             @Parameter(description = "Threshold score, e.g: 0.50")
    ...
    private int compareIntersectionInfo(IntersectionInfo o1, IntersectionInfo o2) {
     ...
     @Operation(summary = "Get reanalysis count for dataset", description = "Retrieve reanalysis count")

...
import uk.ac.ebi.ddi.ws.modules.model.DomainStats;
import uk.ac.ebi.ddi.ws.modules.model.StatOmicsRecord;
import uk.ac.ebi.ddi.ws.modules.model.StatRecord;
import uk.ac.ebi.ddi.ws.modules.util.Constants;
import uk.ac.ebi.ddi.ws.modules.util.RepoStatsToWsStatsMapper;
...
*/
@Tag(name = "statistics", description = "retrieve statistics about the DDI repositories, access, etc")
@Controller
...
public class StatisticsController {
    ...
    private String version;
     ...
     @Operation(summary = "Return statistics about the number of datasets per Repository", description = "Return statistics about the number of datasets per Repository")
    ...
    public List<DomainStats> getDomainEntries(
     ...
     @Operation(summary = "Return statistics about the number of datasets per Organisms", description = "Return statistics about the number of datasets per Organisms")
    ...
    public List<StatRecord> getTaxonomies(
             @Parameter(description = "Organisms to be retrieved: maximum 100")
            @RequestParam(value = "size", required = false, defaultValue = "20") int size,
             @Parameter(description = "domain to find the information, e.g: omics")
            @RequestParam(value = "domain", required = false, defaultValue = "omics") String domain) {
     ...
     @Operation(summary = "Return statistics about the number of datasets per Tissue", description = "Return statistics about the number of datasets per Tissue")
    ...
    public List<StatRecord> getTissues(
             @Parameter(description = "Tissues to be retrieved: maximum 100")
            @RequestParam(value = "size", required = false, defaultValue = "20") int size,
             @Parameter(description = "domain to find the information, e.g: omics")
            @RequestParam(value = "domain", required = false, defaultValue = "omics") String domain) {
        DomainList domainList = null;
     ...
     @Operation(summary = "Return statistics about the number of datasets per Omics Type", description = "Return statistics about the number of datasets per Omics Type")
    ...
    public List<StatRecord> getModelExchange() {
     ...
     @Operation(summary = "Return statistics about the number of datasets per dieases", description = "Return statistics about the number of datasets per diseases")
    ...
    public List<StatRecord> getDiseases(
             @Parameter(description = "Dieseases to be retrieved: maximum 100")
            @RequestParam(value = "size", required = false, defaultValue = "20") int size,
             @Parameter(description = "domain to find the information, e.g: omics")
            @RequestParam(value = "domain", required = false, defaultValue = "omics") String domain) {
     ...
     @Operation(summary = "Return statistics about the number of datasets per repository", description = "Return statistics about the number of datasets per diseases")
    ...
    public List<StatRecord> getRepositories(
             @Parameter(description = "Repository to be retrieved: maximum 100")
            @RequestParam(value = "size", required = false, defaultValue = "20") int size,
             @Parameter(description = "domain to find the information, e.g: omics")
            @RequestParam(value = "domain", required = false, defaultValue = "omics") String domain) {
    ...
    @Hidden
     @Operation(summary = "Get current webservice version", description = "Get current webservice version")
    ...
    public Map<String, String> getVersion() {
     ...
     @Operation(summary = "Return General statistics about the Services", description = "Return General statistics about the Services")
    ...
    public List<StatRecord> getGeneral(
     ...
     @Operation(summary = "Return statistics about the number of datasets By Omics type on recent 5 years ",
            description = "Return statistics about the number of datasets per OmicsType on recent 5 years ")
